package com.hzrhscn.myapplication
...
import com.hzrhscn.myapplication.databinding.ActivityMainBinding
    ...
    private fun copy() {
        if (!binding.textViewResult.text.isNullOrEmpty()) {
            binding.buttonCopy.setOnClickListener {
                ...
                val clip = ClipData.newPlainText("label", binding.textViewResult.text)
